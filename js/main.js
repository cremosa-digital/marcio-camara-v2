    ...
    var clStatCount = function() {
        ...
        statSection.waypoint({
            ...
            handler: function(direction) {
                ...
                if (direction === "down") {
                    var cups = $("#cupsOfCoffee");
                    var inovation = $("#inovationDay");

                    const date1 = new Date('5/20/2019');
                    const date2 = new Date();
                    const diffTime = Math.abs(date2.getTime() - date1.getTime());
                    const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));

                    const cupsOfCoffee = diffDays * 6;

                    $({ Counter: 0 }).animate({ Counter: diffDays }, {
                        duration: 4000,
                        easing: 'swing',
                        step: function (curValue) {
                            inovation.text(Math.ceil(curValue));
                        }
                    });

                    $({ Counter: 0 }).animate({ Counter: cupsOfCoffee }, {
                        duration: 4000,
                        easing: 'swing',
                        step: function (curValue) {
                            cups.text(Math.ceil(curValue));
                        }
                    });
                    ...
                    /*stats.each(function () {
                        ...
                        $({ Counter: 0 }).animate({ Counter: $this.html() }, {
                            duration: 4000,
                            easing: 'swing',
                            step: function (curValue) {
